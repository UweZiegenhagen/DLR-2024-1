...
%\todo , Option `disable ` zum Deaktivieren
\usepackage[]{todonotes}
\newcommand{\insertref}[1]{\todo[color=green!40]{Referenz #1 einbauen!}}
...
\newcommand{\dlr}{Deutsche Zentrum für Luft- und Raumfahrt}
\newcommand{\Dlr}{Deutschem Zentrum für Luft- und Raumfahrt}

% mit newcommand nur neue Befehle definierbar
% sonst renewcommand
%\renewcommand{\person}[1]{\textsc{\textcolor{green}{#1}}}
